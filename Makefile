...
REAL_CC		= $(srctree)/toolchain/gcc-cfp-jopp-only/aarch64-linux-android-4.9/bin/aarch64-linux-android-gcc
CC		= $(srctree)/scripts/gcc-wrapper.py $(REAL_CC)
endif
ifdef CONFIG_RKP_CFP_ROPP
REAL_CC		= $(srctree)/toolchain/gcc-cfp-single/aarch64-linux-android-4.9/bin/aarch64-linux-android-gcc
CC		= $(srctree)/scripts/gcc-wrapper.py $(REAL_CC)
endif
# check for 'asm goto'
